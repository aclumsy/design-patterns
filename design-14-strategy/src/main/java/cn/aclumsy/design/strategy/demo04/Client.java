...
public class Client {
    ...
    public static void main(String[] args) {
        Receipt mt1101 = new Receipt("MT1101", "MT1101");
        ReceiptStrategyContext context = new ReceiptStrategyContext(ReceiptHandlerStrategyFactory.getStrategy(mt1101.getType()));
        context.handleReceipt(mt1101);
